...
INSERT INTO THUOC (TEN_THUOC, LOAI_THUOC, SO_LUONG_TON, HAN_SU_DUNG) 
VALUES 
(N'Paracetamol', N'Giảm đau', 100, '2026-12-25'),
(N'Amoxicillin', N'Kháng sinh', 50, '2028-01-01'),
(N'Vitamin C', N'Vitamin', 200, '2027-06-15'),
(N'Panadol Extra', N'Giảm đau', 150, '2025-05-20');
...
INSERT INTO THUOC (TEN_THUOC, ID_LOAI, SO_LUONG_TON, HAN_SU_DUNG, GIA_BAN)
VALUES (N'Decolgen', 2, 80, '2026-10-10', 12000);
